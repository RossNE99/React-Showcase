  ...
  return (
    <div className="container">
      <div className="row width100">
        <div className="col-md-7 col-sm-12 height100 my-3">
          <div className='left-section shadow-lg p-2 rounded-lg'>
            <div className='mb-2'>
              <h1 className='m-2'>{project.title}</h1>
              <button href={project.repoLink} className='btn btn-primary m-2'>View Repo</button>
              <button href={project.deployedLink} className='btn btn-primary m-2'>Visit Site</button>
            </div>
              ...
              <h2 className='m-2'>Features</h2>
                <ul className='pl-1'>
                  {project.features.map((feature) => (
                    <li className='m-1 my-2 p-2 rounded-lg'>{feature}</li>
                  ))}
              </ul>
            <div className='m-2'>
              <h2>Screen Shots</h2>
            ...
            <div className='m-2 mt-4'>
              ...
              <div className='flex flex-wrap'>
                {project.tags.map((tag) => (
                  <span className="badge badge-pill badge-secondary m-1 shadow-lg">{tag}</span>
                ))}
              </div>
            </div>
          </div>
